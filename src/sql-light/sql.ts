...
export const isGreater = (a: Expression, b: Expression): Predicate => ({ inv: false, cmp: 'greater', args: List([a, b]) });
export const notGreater = (a: Expression, b: Expression): Predicate => ({ inv: true, cmp: 'greater', args: List([a, b]) });

export const isLesser = (a: Expression, b: Expression): Predicate => ({ inv: false, cmp: 'lesser', args: List([a, b]) });
export const notLesser = (a: Expression, b: Expression): Predicate => ({ inv: true, cmp: 'lesser', args: List([a, b]) });
...
export const isBetween = (a: Expression, min: Expression, max: Expression): Predicate => ({ inv: false, cmp: 'between', args: List([a, min, max]) });
export const notBetween = (a: Expression, min: Expression, max: Expression): Predicate => ({ inv: true, cmp: 'between', args: List([a, min, max]) });
...
export const isIn = (a: Expression, ...l: Expression[]): Predicate => ({ inv: false, cmp: 'in', args: List([a, ...l]) });
export const notIn = (a: Expression, ...l: Expression[]): Predicate => ({ inv: true, cmp: 'in', args: List([a, ...l]) });
